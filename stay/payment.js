...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById('payment').addEventListener('submit', (event) => {
    ...
    // If all validations pass, store credit card information in local storage
    ...
    // Redirect to the confirmation page (confirmation.html)
